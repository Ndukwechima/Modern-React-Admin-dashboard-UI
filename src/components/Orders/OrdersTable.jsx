  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row justify-between md:items-center mb-6">
        ...
        <div className="relative">
          <input
            ...
            className="w-40 sm:w-60 bg-[#8000FF] text-white placeholder-white rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
            value={searchTerm}
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-[#8000FF]">
          <thead>
            <tr>
          ...
          <tbody className="divide divide-[#8000FF]">
